In this project, the concept of suer defined function is covered. These are functions that a user defines to avoid writing the same code over and over again when they need it. Besides saving time, functions also make debugging easier as focus is made mostly in the function itself other that the whole code file.

These are the questions answered in this project.

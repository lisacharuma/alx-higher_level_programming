This is an introduction to Inheritance in Python. This is an approach which allows us to define classes witt attributes and methods that are reusable in other classes inheriting from them. This approach reduces redundancy in code as there's no need to write the same piece of code over and over, hence at the same time promoting code reusability.
